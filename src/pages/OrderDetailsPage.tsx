...
// import { ArrowLeft, FileText, XCircle, CheckCircle, Truck, Clock } from 'lucide-react';
...
//             <div>
//               <h1 className="text-2xl font-bold font-serif">Commande #{order.id_commande}</h1>
...
//                   className="grid grid-cols-1 sm:grid-cols-12 p-4 border-b border-slate-200 last:border-b-0"
//                 >
//                   <div className="col-span-6 flex items-center mb-4 sm:mb-0">
//                     <div className="h-16 w-16 bg-slate-100 rounded-md overflow-hidden mr-4">
//                       <img
...
//                         {product.designation}
//                       </Link>
//                       <p className="text-sm text-slate-500">{product.code_produit}</p>
//                     </div>
//                   </div>
...
//                   <p className="text-slate-600">{currentUser.nom}</p>
//                   <p className="text-slate-600">{currentUser.email}</p>
//                   <p className="text-slate-600">{currentUser.contact}</p>
//                 </div>
//               )}

//               {/* Delivery Info */}
//               <div className="mb-6">
//                 <h3 className="font-medium mb-2">Lieu de Livraison</h3>
//                 <p className="text-slate-600">{order.lieu_de_livraison}</p>
//               </div>

//               {/* Payment Info */}
//               <div className="mb-6">
//                 <h3 className="font-medium mb-2">Paiement</h3>
//                 <p className="text-slate-600 capitalize">{order.mode_de_paiement}</p>
//               </div>
...
//                 </div>
//                 <div className="flex justify-between py-2 font-bold border-t border-slate-200 mt-2 pt-3">
//                   <span>Total</span>
